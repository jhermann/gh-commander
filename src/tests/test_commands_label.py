...
@cli
def test_command_label_list_has_mocked_data(tmpdir, apimock):
    runner = CliRunner()
...
@cli
def test_command_label_export_takes_all_explicit_formats(tmpdir, apimock):
    runner = CliRunner()
...
@cli
def test_command_label_export_dash_writes_to_stdout(apimock):
    runner = CliRunner()
